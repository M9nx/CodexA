...
### v0.8.0
Release automation, compatibility guarantees, and artifact maturity.

## Status Labels

- **Current:** Actively being prepared
- **Planned:** Approved direction, not started
- **Experimental:** Available but not yet covered by stable guarantees
