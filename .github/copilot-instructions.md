...
1. Always use `--json` flag for machine-readable output when running codex commands.
...
7. Use `codex tool run get_call_graph` to understand function relationships.
8. Use `codex tool run find_references` to assess change impact.
